...
class BCLSTMModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--bidirectional', type=bool, default='True', help='models image are saved here')
        return parser
    ...
    def __init__(self, opt):
        ...
        # classifier
        cls_size = opt.embd_size_a
        self.netC = LSTMEncoder(input_size=cls_size, hidden_size=opt.output_dim, bidirectional=opt.bidirectional,
                                embd_method='dense')
    ...
    def forward(self):
        ...
        self.logits = self.netC(self.feat_fusion_miss)
        if self.opt.corpus_name != 'MOSI':
